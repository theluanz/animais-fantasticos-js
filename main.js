...
eval("module.exports = __webpack_require__(/*! regenerator-runtime */ \"./node_modules/regenerator-runtime/runtime.js\");\n\n\n//# sourceURL=webpack://project/./node_modules/@babel/runtime/regenerator/index.js?");

/***/ }),

/***/ "./js/modules/accordionAnimate.js":
/*!****************************************!*\
  !*** ./js/modules/accordionAnimate.js ***!
  \****************************************/
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ initAnimationScroll)\n/* harmony export */ });\nfunction initAnimationScroll() {\n  var sectionScroll = document.querySelectorAll('[data-anime=\"scroll\"]');\n  var windowSizeBreak = window.innerHeight * 0.6;\n\n  function animateSectionScroll() {\n    sectionScroll.forEach(function (item) {\n      var sectionIsVisible = item.getBoundingClientRect().top - windowSizeBreak;\n\n      if (sectionIsVisible < 0) {\n        item.classList.add('ativo');\n      } else if (item.classList.contains('ativo')) {\n        item.classList.remove('ativo');\n      }\n    });\n  }\n\n  animateSectionScroll();\n  window.addEventListener('scroll', animateSectionScroll);\n}\n\n//# sourceURL=webpack://project/./js/modules/animationOnScroll.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ initHours)\n/* harmony export */ });\nfunction initHours() {\n  var worksWekeend = document.querySelector('[data-wekeend]');\n  var days = worksWekeend.dataset.wekeend.split(',').map(Number);\n  var worksAtHours = document.querySelector('[data-hours]');\n  var hours = worksAtHours.dataset.hours.split(',').map(Number);\n  var today = new Date();\n  var isOpen = today.getHours() >= hours[0] && days.indexOf(today.getDay()) !== -1 && today.getHours() < hours[1];\n\n  if (isOpen) {\n    worksWekeend.classList.add('isOpen');\n  }\n}\n\n//# sourceURL=webpack://project/./js/modules/hours.js?");
